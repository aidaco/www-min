...
def get_contact_links(db: database.Database) -> dict[CategoryType, list[LinkType]]:
    result: dict[CategoryType, list[LinkType]] = db.contact_links.group_by_category()  # type: ignore
